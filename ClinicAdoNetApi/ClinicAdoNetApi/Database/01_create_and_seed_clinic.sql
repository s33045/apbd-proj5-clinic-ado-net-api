IF
    DB_ID(N'ClinicAdoNet') IS NULL
    BEGIN
        CREATE
            DATABASE ClinicAdoNet;
    END;
GO
...
(
    IdSpecialization INT IDENTITY (1,1)
...
(
    ...
    IsActive         BIT          NOT NULL
        CONSTRAINT DF_Doctors_IsActive DEFAULT 1,
...
(
    ...
    CreatedAt       DATETIME2(0)  NOT NULL
        CONSTRAINT DF_Appointments_CreatedAt DEFAULT SYSUTCDATETIME(),
...
VALUES (N'Anna', N'Kowalska', N'anna.kowalska@example.com', N'+48 500 100 100', '1995-04-12', 1),
...
VALUES (1, N'Ewa', N'Mazur', N'CARD-1001', 1),
...
VALUES (1, 1, DATEADD(DAY, 2, SYSUTCDATETIME()), N'Scheduled', N'Blood pressure consultation', NULL),
